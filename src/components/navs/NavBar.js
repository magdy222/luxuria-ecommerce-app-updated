  ...
  return (
    ...
    <div className='grid sm:grid-cols-1 md:grid-cols-3 gap-5 lg:gap-10  justify-items-center py-2 '>
      <div className='flex gap-2 '>
        ...
        <div>
            <Link to={'/'}><h2 className='uppercase text-2xl lg:text-3xl font-bold first-letter:text-pink-500 text-black no-underline'>{t('title')}</h2></Link>
        </div>
        
        <div className='flex items-center justify-center pb-2 text-black no-underline'>
        {!currentUser ?  (<div className='flex '>
          ...
          <Link to={'/login'}><h4 className='px-2  text-black no-underline'>{t("login")}</h4></Link>
            </div>) : <p className='px-1 lg:px-3 text-cyan-600'>{currentUser.email}</p>
        }
        {!currentUser ? "" : 
            ...
            <div className='flex items-center justify-center px-3 relative'>
              <Link to={'/cart'}>
